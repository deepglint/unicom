...
export BASE_RUN_NAME=finetune_Llava-Onevision-baseline-mlcd-qwen2.5

export LLM_VERSION=/home/vlm/pretrain_model/Qwen2.5-7B-Instruct
export VISION_MODEL_VERSION=/home/vlm/pretrain_model/mlcd-vit-large-patch14-336

export MM_PROJECTOR=mm-projection_Qwen2.5-7B-Instruct_mlcd-vit-large-patch14-336
