...
from vit_rope2d import RoPE2d_ViT_bigG_14_1024
from vit_rope2d_hf import (
    BaseModelOutputWithPooling, MLCDVisionConfig, MLCDVisionModel)
...
def convert_clip_checkpoint(
    ...
    # naive
    pt_image = _transform(image_size)(image)
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--model_name", default="RoPE2d_ViT_bigG_14_1024")
    args = parser.parse_args()

    convert_clip_checkpoint(args.checkpoint_path, args.pytorch_dump_folder_path, args.image_size)
