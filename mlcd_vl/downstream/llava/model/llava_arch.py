...
from llava.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, DEFAULT_SEG_TOKEN
...
class LlavaMetaModel:
    ...
    def __init__(self, config):
        ...
        if hasattr(config, "mm_vision_tower"):
            ...
            if getattr(config, 'sam_path', None) is not None:
                self.sam = build_sam_vit_h(config.sam_path)
...
class LlavaMetaForCausalLM(ABC):
    ...
    def initialize_vision_tokenizer(self, model_args, tokenizer):
        ...
        tokenizer.add_tokens([DEFAULT_SEG_TOKEN], special_tokens=True)
        self.resize_token_embeddings(len(tokenizer))
